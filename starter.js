...
// // Sol-3
// const theEvents = [...gameEvents];
// const numberOfEvents = 90 / theEvents.length;
// // console.log(`An event happened, on an average, every ${numberOfEvents} minutes.`);
...
// const lastElement = time.pop();
// console.log(lastElement);
// console.log(`An event happened, on an average, every ${lastElement / gameEvents.size} minutes.`);
